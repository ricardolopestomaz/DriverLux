            ...
            <div class="content-wrapper">
                ...
                <div class="filtros">
                    ...
                    <a href="admin.php?categoria_id=3"
                        class="category-btn <?= $categoria_id == 3 ? 'active' : '' ?>">Max</a>
                ...
                <div class="fleet-section">
                    <div class="section-header">
                        ...
                        <span class="section-count"><?= count($veiculos) ?>
                            veículo<?= count($veiculos) !== 1 ? 's' : '' ?></span>
                    </div>
                            ...
                            <?php foreach ($veiculos as $carro):
                                ...
                                <div class="card-veiculo">
                                    ...
                                    <div class="card-info">
                                        ...
                                        <h3><?= htmlspecialchars($carro['marca']) ?>         <?= htmlspecialchars($carro['modelo']) ?>
                                        </h3>
                                        <div class="card-meta">
                                        ...
                                        <div class="card-footer">
                                            <div class="card-preco">
                                                ...
                                                <span
                                                    class="preco-val"><?= number_format($carro['valor_base_diaria'], 0, ',', '.') ?></span>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="foto_carro" id="v_foto" accept="image/png, image/jpeg, image/webp"
