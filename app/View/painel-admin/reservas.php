...
<div class="admin-container">
    ...
    <aside id="sidebar">
        ...
        <nav>
                ...
                <a href="usuarios.php" class="<?= basename($_SERVER['PHP_SELF']) == 'usuarios.php' ? 'ativo' : '' ?>">
                        ...
                        <?php if (count($reservas) > 0): ?>
                            ...
                            ?>
                                <tr style="border-bottom: 1px solid #eee; height: 55px; font-size:14px;">
                                    ...
                                    <td><strong>R$ <?= number_format($res['valor_total_previsto'], 2, ',', '.') ?></strong></td>
                                    <td><span style="color: <?= $st['cor'] ?>; font-weight: bold;"><?= $st['txt'] ?></span></td>
                                    <td>
