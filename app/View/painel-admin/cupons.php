            ...
            <header class="admin-topbar">
                ...
                <div class="topbar-acoes">
                    <button class="btn-adicionar"
                        onclick="document.getElementById('modalCupom').classList.add('active')">＋ Novo Cupom</button>
                </div>
            </header>
                            ...
                            <?php if (count($cupons) > 0): ?>
                                <?php foreach ($cupons as $cupom):
                                    ...
                                    <tr style="border-bottom: 1px solid #eee; height: 50px; font-size:14px;">
                                        <td><span class="tag-categoria"
                                                style="background: #e8f0fe; color: #1a73e8; padding: 4px 8px; font-family: monospace; font-size: 14px; border-radius: 4px; font-weight: bold;"><?= htmlspecialchars($cupom['codigo']) ?></span>
                                        </td>
                                        <td><span
                                                style="color:#666; font-size:13px;"><?= htmlspecialchars($cupom['descricao'] ?? 'Sem descrição') ?></span>
                                        </td>
                                        ...
                                        <td>
                                            <button class="btn-adicionar"
                                                style="padding: 5px 10px; font-size: 12px; background-color: #3498db;"
                                                onclick='abrirModalEditar(<?= json_encode($cupom); ?>)'>Editar</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr>
                                    <td colspan="7" style="text-align: center; padding: 30px; color: #777;">Nenhum cupom
                                        cadastrado ainda.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
        ...
        <div class="modal-content" style="max-width: 480px;">
            <div class="modal-header">
                ...
                <button type="button" class="close-modal"
                    onclick="document.getElementById('modalCupom').classList.remove('active')">×</button>
            </div>
            <form method="POST" action="cupons.php">
                ...
                <div class="modal-body" style="display:flex; flex-direction:column; gap:15px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="codigo" required placeholder="Ex: DRIVERLUX10"
                            style="width:100%; padding:10px; border-radius:6px; border:1px solid #ccc; font-weight: bold; text-transform: uppercase;">
                    </div>

                    <div class="form-group">
                        <label style="font-weight: 500; font-size:14px;">Descrição / Motivo</label>
                        <input type="text" name="descricao" placeholder="Ex: Desconto de Boas-vindas"
                    ...
                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:15px;">
                        <div class="form-group">
                            ...
                            <select name="tipo_desconto" required
                                style="width:100%; padding:10px; border-radius:6px; border:1px solid #ccc; background:#fff;">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="valor_desconto" required placeholder="Ex: 15.00"
                                style="width:100%; padding:10px; border-radius:6px; border:1px solid #ccc;">
                        </div>
                    </div>
                    ...
                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:15px;">
                        <div class="form-group">
                            ...
                            <input type="number" name="limite_usos" placeholder="Vazio para ilimitado"
                                style="width:100%; padding:10px; border-radius:6px; border:1px solid #ccc;">
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-footer" style="margin-top:20px;">
                    <button type="submit" class="btn-save" style="width:100%; padding:12px;">Salvar e Ativar
                        Cupom</button>
                </div>
            </form>
        </div>
    ...
    <div id="modalEditarCupom" class="modal">
        <div class="modal-content" style="max-width: 480px;">
            <div class="modal-header">
                ...
                <button type="button" class="close-modal"
                    onclick="document.getElementById('modalEditarCupom').classList.remove('active')">×</button>
            </div>
            <form method="POST" action="cupons.php">
                ...
                <div class="modal-body" style="display:flex; flex-direction:column; gap:15px;">
                    ...
                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:15px;">
                        <div class="form-group">
                            <label style="font-weight: 500; font-size:14px;">Tipo de Desconto</label>
                            <select id="edit_tipo_desconto" name="tipo_desconto" required
                                style="width:100%; padding:10px; border-radius:6px; border:1px solid #ccc; background:#fff;">
                                <option value="percentual">Percentual (%)</option>
                                <option value="valor_fixo">Valor Fixo (R$)</option>
                            </select>
                        ...
                        <div class="form-group">
                            <label style="font-weight: 500; font-size:14px;">Valor do Desconto</label>
                            <input type="number" step="0.01" id="edit_valor_desconto" name="valor_desconto" required
                                style="width:100%; padding:10px; border-radius:6px; border:1px solid #ccc;">
                        </div>
                    </div>
                    ...
                    <div style="display:grid; grid-template-columns: 1fr 1fr; gap:15px;">
                        <div class="form-group">
                            <label style="font-weight: 500; font-size:14px;">Limite de Usos (Opcional)</label>
                            <input type="number" id="edit_limite_usos" name="limite_usos"
                    ...
                    <div class="form-group">
                        ...
                        <select id="edit_ativo" name="ativo" required
                            style="width:100%; padding:10px; border-radius:6px; border:1px solid #ccc; background:#fff; font-weight: bold;">
                ...
                <div class="modal-footer" style="margin-top:20px;">
                    <button type="submit" class="btn-save"
                        style="width:100%; padding:12px; background-color: #3498db;">Atualizar Alterações</button>
                </div>
            </form>
        </div>
    </div>
