    ...
    <div class="faixa-inner">
        ...
        <div class="resumo-pill">
            <div class="resumo-item">
                ...
                <span class="resumo-valor" id="resumo-retirada">📍 Local não informado</span>
            </div>
            ...
            <div class="resumo-item">
                ...
                <span class="resumo-valor" id="resumo-periodo">📅 Não informado</span>
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (resumoRetirada && dadosReserva.local_retirada) {
        resumoRetirada.textContent = '📍 ' + dadosReserva.local_retirada;
    }

    if (resumoPeriodo && dadosReserva.data_retirada && dadosReserva.hora_retirada) {
        const dataBR = dadosReserva.data_retirada.split('-').reverse().join('/');
    ...
    function aplicarFiltros() {
        const catSelecionadas = Array.from(checkboxesCat)
        ...
        const precoMaximo = sliderPreco ? parseFloat(sliderPreco.value) : Infinity;
        ...
        cards.forEach(card => {
            ...
            card.style.display = passaCat && passaMarca && passaPreco ? 'flex' : 'none';
        });
    }
