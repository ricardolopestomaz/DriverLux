...
**👥 Equipe**
* [**Anna Beatriz Moura de Oliveira**](https://github.com/bibimoura)
* [**Grazyelle Nayara Bento dos Santos**](https://github.com/Grazynaay)
...
|-----------------|----------------|----------------| ----------------| 
| [v0.5.0](https://github.com/ricardolopestomaz/DriverLux/releases/tag/v0.5.0) | [Assistir vídeo](https://drive.google.com/file/d/1hWCukXE0qe_OrzoRnwaUddgPw9UiVU2_/view?usp=sharing) | [Acessar](https://ricardolopestomaz.github.io/DriverLux/) |[Ver Apresentação](https://www.canva.com/design/DAHMHHZV-K8/QHKHtbq91dWaFS3ozb0oKg/view?utm_content=DAHMHHZV-K8&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=hf434b5915d) |
...
1. **Clone o repositório** dentro da pasta `htdocs` do seu servidor local (XAMPP/WAMP).
   >    ```bash
   >  git clone https://github.com/ricardolopestomaz/DriverLux.git
